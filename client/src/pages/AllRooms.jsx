...
const AllRooms = () => {
  ...
  return (
<div class="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-35 px-4 md:px-16 lg:px-24 xl:px-32 bg-gray-200">       
     <div>
...
{/* Filter */}
        <div className='bg-gray-200 w-80 border border-gray-400 text-gray-600 max-lg:mb-8 min-lg:mt-16'>
            <div className={`flex items-center justify-between px-5 py-2.5 min-lg:border-b border-gray-300 ${openFilters && "border-b"} `}>
                <p className='text-base font-medium text-gray600'>FILTERS</p>
            ...
            <div className={`${openFilters ? 'h-auto' : 'h-0 lg:h-auto'} overflow-hidden transition-all duration-700`}>
                <div className='px-5 pt-5 '>
                    <p className='font-medium tect-gray-800 pb-2'>Popular filters</p>
                ...
                <div className='px-5 pt-5 '>
                    <p className='font-medium tect-gray-800 pb-2'>Price Range</p>
                ...
                <div className='px-5 pt-5 pb-7 '>
                    <p className='font-medium tect-gray-800 pb-2'>Sort By</p>
